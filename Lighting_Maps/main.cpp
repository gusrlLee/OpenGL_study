...
int main() {
    ...
    Shader lightingShader("../Lighting_Maps/vertex_shader.glsl", "../Lighting_Maps/fragment_shader.glsl");
    Shader lightingCubeShader("../Lighting_Maps/light_vertex_shader.glsl", "../Lighting_Maps/light_fragment_shader.glsl");
    ...
    // second, configure the lights VAO; the vertices are the same for the light object which is also a 3D cube
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // view/projection transfromations
