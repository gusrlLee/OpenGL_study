...
int main() {
    ...
    Shader lightingShader("../Multiple_lights/vertex_shader.glsl", "../Multiple_lights/fragment_shader.glsl");
    Shader lightCubeShader("../Multiple_lights/light_vertex_shader.glsl", "../Multiple_lights/light_fragment_shader.glsl");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        lightingShader.setVec3("dirLight.specular", -0.2f, -1.0f, -0.3f);
